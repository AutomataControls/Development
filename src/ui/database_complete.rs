...
impl DatabaseViewer {
    ...
    fn execute_sql_query(&mut self) {
        ...
        self.sql_query_result = Some(SqlQueryResult {
            columns: vec!["timestamp".to_string(), "channel".to_string(), "value".to_string()],
            rows: vec![
                vec!["2024-01-15 10:00:00".to_string(), "Temperature".to_string(), "72.5".to_string()],
                vec!["2024-01-15 10:01:00".to_string(), "Temperature".to_string(), "72.8".to_string()],
            ],
            row_count: 2,
    ...
    fn save_retention_config(&mut self) {
        ...
        println!("Saving retention config: {:?}", self.retention_config);
