...
// Python interface path - using the existing working interface
const PYTHON_INTERFACE: &str = "/home/Automata/Development/projects/building-automation-controller-rpi5-ssd/scripts/megabas_interface.py";
...
impl BoardManager {
    ...
    pub async fn scan_boards(&self) -> Result<Vec<BoardInfo>> {
        // Use existing Python interface to scan boards
